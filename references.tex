...
\begin{enumerate}
    ...
    \item Peter Shirley and Steve Marschner, Fundamentals of Computer Graphics, 5th Ed.
	\item Sheldon Axler, Linear Algebra Done Right, 4th Ed. \url{https://linear.axler.net/}
	\item Gilbert Strang, Linear Algebra and Its Applications, 4th Ed. 
\end{enumerate}
...
\begin{enumerate}
    \item James F. Blinn, Hyperbolic Interpolation: \url{https://ieeexplore.ieee.org/document/8891846}
     \item Juan Pineda, A parallel algorithm for polygon rasterization: \url{https://dl.acm.org/doi/10.1145/54852.378457}
      ...
      \item Ivan E. Sutherland, Gary W. Hodgeman, Reentrant polygon clipping: \url{https://dl.acm.org/doi/10.1145/360767.360802}
\end{enumerate}

\section{Code Examples}
\begin{enumerate}
    \item Rasterizer1 \url{https://github.com/andrew-lim/sw3dcpp/}
    \item Rasterizer2 \url{https://github.com/gustavopezzi/triangle-rasterizer-float/}
    \item Rasterizer3 \url{https://github.com/gustavopezzi/triangle-rasterizer-fix16}
    \item Rasterizer4 \url{https://github.com/gustavopezzi/triangle-rasterizer-int}
\end{enumerate}
\clearpage